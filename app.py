...
This Streamlit application fetches real-time weather data for a given city, 
displays the current temperature in the selected unit (Celsius, Fahrenheit, or Kelvin), 
and provides a weekly weather forecast.

Modules Used:
- streamlit: For building the web interface
- logging: For logging application events
- modules.api_handler: Handles API calls for weather data
- modules.ui_components: Renders UI components
- modules.utils: Utility functions for temperature conversion and logging setup

Contributors: Paramjit Singh, Utkarsh Agrawal, Prabhu Prasad Sahoo, Pratyush Pandey
Collaborators: Sachin Rajendran, Rakesh Sriramula
